...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/KeViNTm/Files-KeViN/master/File_Bot/commands.lua") 
...
local KeViN_Msg = ''  
if msgs < 100 then 
KeViN_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
KeViN_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
KeViN_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
KeViN_Msg = 'متفاعل' 
elseif msgs < 1200 then 
KeViN_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
KeViN_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
KeViN_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
KeViN_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
KeViN_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
KeViN_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
KeViN_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
KeViN_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
KeViN_Msg = 'رب التفاعل'  
end 
return KeViN_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceKeViN(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,KeViN_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf KeViN.lua')
os.execute('wget https://raw.githubusercontent.com/KeViNTm/KeViNTAEM/master/KeViN.lua')
...
send(msg.chat_id_, msg.id_,'✸∫  عدد الكروبات الان » { '..#group..' }'..KeViNk..''..KeViN..'\n✸∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ✸∫ العضو » ['..result.title_..'](t.me/'..(username or 'KeViN0')..')'
status  = '\n ✸∫ تم ترقيته مطور'
...
usertext = '\n ✸∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KeViN0')..')'
status  = '\n ✸∫ تم ترقيته مطور'
...
local KeViN1_Msg = database:get(bot_id.."KeViN1:Add:Filter:Rp2"..text..msg.chat_id_)   
if KeViN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✸∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'KeViN0')..') \n ✸∫ '..KeViN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if KeViN_Msg and not Special(msg) then  
local KeViN_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if KeViN_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✸∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✸∫ ["..KeViN_Msg.."] \n")
else
send(msg.chat_id_,0," ✸∫ العضو : {["..data.first_name_.."](T.ME/KeViN0)}\n ✸∫ ["..KeViN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✸∫ عذرا » {["..data.first_name_.."](T.ME/KeViN0)}\n ✸∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✸∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'KeViN0')..') \n ✸∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✸∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'KeViN0')..') \n ✸∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/KeViNTm/Files-KeViN/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✸∫ اهلا بك في متجر ملفات فانۨــہدامۘ⁶³\n ✸∫ ملفات السورس ↓\n≪━━━━━━━━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━━━━━━━━≫\n ✸∫ علامة تعني { ✓ } ملف مفعل\n ✸∫ علامة تعني { ✘ } ملف معطل\n ✸∫ قناة سورس فانۨــہدامۘ⁶³ ↓\n".." ✸∫ [اضغط هنا لدخول](t.me/KeViN0) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/KeViNTm/Files-KeViN/master/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✸∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KeViN0')..')'
status  = '\n ✸∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✸∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✸∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KeViN0')..')'
...
database:set(bot_id.."KeViN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."KeViN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ✸∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."KeViN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."KeViN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."KeViN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."KeViN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ✸∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."KeViN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."KeViN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."KeViN1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."KeViN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ✸∫ ارسل الكلمه الان")  
database:set(bot_id.."KeViN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."KeViN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."KeViN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KeViN1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."KeViN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."KeViN1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."KeViN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KeViN1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."KeViN1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ✸∫ قائمة المنع \n≪━━━━━━━━━━━━━≫\n"
for k,v in pairs(list) do  
local KeViN_Msg = database:get(bot_id.."KeViN1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..KeViN_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✸∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'KeViN0')..')'..'\n ✸∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..KeViN_Msg[math.random(#KeViN_Msg)]..']') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'KeViN0')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
KeViNdx(msg.chat_id_, msg.id_, ' ✸∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ✸∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ✸∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ✸∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
KeViN = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(KeViN)
...
--------------------------------------------------------------------------------------------------------------
SourceKeViN(data.message_,data)
...
------------------------------------------------------------------------
local KeViNAbot = database:get(bot_id.."KeViN1:Add:Filter:Rp2"..text..result.chat_id_)   
if KeViNAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✸∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✸∫ ["..KeViNAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local KeViN1_Msg = database:get(bot_id.."KeViN1:Add:Filter:Rp2"..text..result.chat_id_)   
if KeViN1_Msg then    
send(msg.chat_id_, msg.id_," ✸∫ "..KeViN1_Msg)
