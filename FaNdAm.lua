...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/FaNdAmTEAM/Files_FaNdAm/master/File_Bot/commands.lua") 
...
local json_file, res = https.request("https://raw.githubusercontent.com/FaNdAmTEAM/Files_FaNdAm/master/File_Bot/"..file)
if res == 200 then
...
--------------------------------
if text == "انجب" or text == "انجب😂" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"اخلاقك 😒"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "شبيك" or text == "شبيكك" or text == "شبيككك" or text == "شبيك يول" or text == "شبيك ضايج" or text == "شبيكك ضايج" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"😤مالك دخل 😕","معليك انته شبيه 😐","مو مستواك اسف 😒","تريد الصدك لو ئبن عمته 😶","قافلين عليك "}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
if text == "شلونكك" or text == "شلونك" or text == "شلونكم" or text == "كيفكم" or text == "اخبارك" or text == "اخباركم" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"احسن منك 😂","تمام وانت❤","زين الحمدلله وانت "}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "شنو رئيك بهذا" or text == "شنو رئيك بهذ" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ادب غ يباوع علي بنات 😂🥺"," مو خوش ولد 😶","زاحف وما احبه 😾😹"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
