...
while(true) do
rm -fr ../.telegram-cli
screen -S FaNdAm -X kill
screen -S FaNdAm ./FaNdAm
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/FaNdAmTm/Files-FaNdAm/master/File_Bot/commands.lua") 
...
local FaNdAm_Msg = ''  
if msgs < 100 then 
FaNdAm_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
FaNdAm_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
FaNdAm_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
FaNdAm_Msg = 'متفاعل' 
elseif msgs < 1200 then 
FaNdAm_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
FaNdAm_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
FaNdAm_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
FaNdAm_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
FaNdAm_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
FaNdAm_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
FaNdAm_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
FaNdAm_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
FaNdAm_Msg = 'رب التفاعل'  
end 
return FaNdAm_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceFaNdAm(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,FaNdAm_Msg) 
return false  
end 
if text then    
...
os.execute('wget https://raw.githubusercontent.com/FaNdAmTm/FaNdAmTAEM/master/FaNdAm.lua')
send(msg.chat_id_, msg.id_,' ✸∫ تم تحديث السورس \n ✸∫ لديك اخر اصدار لسورس فانۨــہدامۘ⁶³\n ✸∫ الاصدار » { 1.3v}')
dofile('FaNdAm.lua')  
end
if text == 'الاصدار ✸' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✸∫ اصدار سورس فانۨــہدامۘ⁶³ \n ✸∫ الاصدار »{ 1.3v}')
end
...
send(msg.chat_id_, msg.id_,'✸∫  عدد الكروبات الان » { '..#group..' }'..FaNdAmk..''..FaNdAm..'\n✸∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
local FaNdAm1_Msg = database:get(bot_id.."FaNdAm1:Add:Filter:Rp2"..text..msg.chat_id_)   
if FaNdAm1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✸∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'fandam0')..') \n ✸∫ '..FaNdAm1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if FaNdAm_Msg and not Special(msg) then  
local FaNdAm_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if FaNdAm_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✸∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✸∫ ["..FaNdAm_Msg.."] \n")
else
send(msg.chat_id_,0," ✸∫ العضو : {["..data.first_name_.."](T.ME/fandam0)}\n ✸∫ ["..FaNdAm_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✸∫ عذرا » {["..data.first_name_.."](T.ME/fandam0)}\n ✸∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖤍᭄ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fandam0')..')'
status  = '\n 𖤍᭄ تم الغاء (الحظر-الكتم) عام من الكروبات'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖤍᭄ العضو » '..userid..''
status  = '\n 𖤍᭄ تم حظره عام من الكروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end;end,nil)
return false
end
...
if Get_info then
local TextS = "\n 𖤍᭄ اهلا بك في متجر ملفات فانۨــہدامۘ⁶³\n 𖤍᭄ ملفات السورس ↓\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ\n\n"
local TextE = "\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ\n 𖤍᭄ علامة تعني { ✓ } ملف مفعل\n 𖤍᭄ علامة تعني { ✘ } ملف معطل\n 𖤍᭄ قناة سورس فانۨــہدامۘ⁶³ ↓\n".." 𖤍᭄ [اضغط هنا لدخول](t.me/XMGXM) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 𖤍᭄ لا يوجد اتصال من ال api \n") 
end
return false
end
end
...
t = " 𖤍᭄ بالتاكيد تم تعطيل ملف → "..file.."\n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/FaNdAmTm/Files-FaNdAm/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('FaNdAm.lua')  
else
send(msg.chat_id_, msg.id_," 𖤍᭄ عذرا الملف لايدعم سورس فانۨــہدامۘ⁶³ \n") 
end
return false
end
...
if file_bot then
io.close(file_bot)
t = " 𖤍᭄ بالتاكيد تم تفعيل ملف → "..file.." \n"
else
t = " 𖤍᭄ الملف » "..file.."\n 𖤍᭄ تم تفعيل ملف \n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/FaNdAmTm/Files-FaNdAm/master/File_Bot/"..file)
...
send(msg.chat_id_,msg.id_," 𖤍᭄ تم مسح الملفات")
return false
end
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ لا تستطيع استخدام البوت \n  𖤍᭄ يرجى الاشتراك بالقناه اولا \n  𖤍᭄ اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n 𖤍᭄ العضو » ['..result.title_..'](t.me/'..(username or 'fandam0')..')'
status  = '\n 𖤍᭄ تم ترقيته مطور'
texts = usertext..status
else
texts = ' 𖤍᭄ لا يوجد حساب بهاذا المعرف'
end
send(msg.chat_id_, msg.id_, texts)
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 𖤍᭄ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
end      
...
send(msg.chat_id_, msg.id_," 𖤍᭄ حساب المنشئ محذوف")
return false  
end
local UserName = (b.username_ or "TSHAKETEAM")
send(msg.chat_id_, msg.id_," 𖤍᭄ منشئ الكروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
usertext = '\n 𖤍᭄ العضو » ['..result.title_..'](t.me/'..(username or 'XMGXM')..')'
status  = '\n 𖤍᭄ تم تنزيله من المنشئين'
texts = usertext..status
else
texts = ' 𖤍᭄ لا يوجد حساب بهاذا المعرف'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖤍᭄ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XMGXM')..')'
status  = '\n 𖤍᭄ تم تنزيله من المنشئين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖤍᭄ العضو » '..userid..''
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," 𖤍᭄ لا يوجد ادمنيه ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_," 𖤍᭄ تمت ترقيه { "..num2.." } من الادمنيه") 
end
end,nil)   
end
if text == 'مسح الادمنيه' and Manager(msg) then
database:del(bot_id..'Mod:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤍᭄ تم مسح الادمنيه')
end
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم تعطيل الرفع') 
return false
end
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم تعطيل الطرد') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖤍᭄ لا تسطيع طرد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖤍᭄ عذرا لا تستطيع طرد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' 𖤍᭄  ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖤍᭄ البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XMGXM')..')'
...
send(msg.chat_id_, msg.id_, '\n 𖤍᭄ عذرا لا تستطيع طرد ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⚠| عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
send(msg.chat_id_, msg.id_, ' 𖤍᭄ لا يوجد حساب بهاذا المعرف')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
return false
...
send(msg.chat_id_, msg.id_, '\n 𖤍᭄ عذرا لا تستطيع طرد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, ' 𖤍᭄ تم مسح المميزين')
end
if text == ("المميزين") and Mod(msg) then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n 𖤍᭄ قائمة مميزين الكروب \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖤍᭄ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XMGXM')..')'
status  = '\n 𖤍᭄ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖤍᭄ العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, ' 𖤍᭄ تم مسح جميع المطايه')
end
if text == ("تاك للمطايه") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n 𖤍᭄ قائمة مطايه الكروب \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XMGXM')..')'
local  statuss  = '\n 𖤍᭄ تم رفع العضو مطي في الكروب \n 𖤍᭄ تعال حبي استلم العربانه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XMGXM')..')'
status  = '\n 𖤍᭄ تم تنزيل العضو مطي في الكروب\n 𖤍᭄ تعال حبي رجع العربانه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖤍᭄ تم رفع العضــو الحاته في الكروب \n 𖤍᭄ تعال يحاته ممكن نتعرف'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fandam0')..')'
status  = '\n 𖤍᭄ تم تنزيل العضــو الحاته من الكروب\n 𖤍᭄ مشيي مو خوش حاتهه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XMGXM')..')'
local  statuss  = '\n 𖤍᭄ تم رفع العضــو الحات في الكروب \n 𖤍᭄ تعال حبي الحات نطيني بوسه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XMGXM')..')'
status  = '\n 𖤍᭄ تم تنزيل العضــو الحات من الكروب\n 𖤍᭄ مشيي مو خوش حات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤍᭄ تم تنزيل جميع صخوله من الكروب')
end
if text == ("تاك للصخوله") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n 𖤍᭄ قائمة صخوله الكروب \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XMGXM')..')'
local  statuss  = '\n 𖤍᭄ تم رفع المتهم صخل بالكروب\n 𖤍᭄ الان اصبح صخل الكروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤍᭄ تم تنزيل جميع جلاب الكروب')
end
if text == ("تاك للجلاب") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n 𖤍᭄ قائمة الجلاب الكروب \n≪━━━━━━━━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fandam0')..')'
local  statuss  = '\n 𖤍᭄ تم رفع جلب في الكروب\n 𖤍᭄ تعال حبي اطيك عضمه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤍᭄ تم تنزيل جميع القروده بالكروب')
end
if text == ("تاك للقروده") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n 𖤍᭄ قائمة القروده الكروب \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XMGXM')..')'
local  statuss  = '\n 𖤍᭄ تم رفع قرد في الكروب\n 𖤍᭄ تعال حبي استلم موزه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XMGXM')..')'
local  statuss  = '\n 𖤍᭄ تم رفع حصان في الكروب\n 𖤍᭄ تعال حبي احطلك سرج وركبك فرني فره حلوه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤍᭄ تم تنزيل جميع البقرات بالكروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n 𖤍᭄ قائمة البقرات الكروب \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fandam0')..')'
local  statuss  = '\n 𖤍᭄ تم رفع بقره في الكروب\n 𖤍᭄ ها يالهايشه تع احلبك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✸∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fandam0')..')'
status  = '\n 𖤍᭄ تم تنزيل بقره من الكروب\n 𖤍᭄ تعال هاك حليب مالتك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤍᭄ تم تنزيل جميع طليان بالكروب')
end
if text == ("تاك للطليان") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n 𖤍᭄ قائمة الطليان الكروب \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XMGXM')..')'
local  statuss  = '\n 𖤍᭄ تم رفع الطلي في الكروب\n 𖤍᭄ طلع برا ابو البعرور الوصخ'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤍᭄ تم تنزيل جميع زواحف')
end
if text == ("تاك للزواحف") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 𖤍᭄ قائمة الزواحف الكروب \n≪━━━━━━━━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XMGXM')..')'
local  statuss  = '\n 𖤍᭄ تم رفع زاحف في الكروب\n 𖤍᭄ كمشتك حبي جيب رقم'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XMGXM')..')'
status  = '\n 𖤍᭄ تم تنزيل زاحف من الكروب\n 𖤍᭄ هاك حبي هاذا رقم مالك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤍᭄ تم تنزيل جميع جريزي')
end
if text == ("تاك للجريذيه") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n 𖤍᭄ قائمة الجريذيه الكروب \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fandam0')..')'
local  statuss  = '\n 𖤍᭄ تم رفع جريذي في الكروب\n 𖤍᭄ خايس ريحتك موتتنه روح سبح يع'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم تعطيل الحظر') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖤍᭄ لا تسطيع حظر البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖤍᭄ عذرا لا تستطيع حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if result.id_ then
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖤍᭄ عذرا لا تستطيع حظر ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 𖤍᭄ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
usertext = '\n 𖤍᭄  المستخدم » ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n 𖤍᭄ تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖤍᭄ عذرا لا تستطيع حظر ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' 𖤍᭄ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, ' 𖤍᭄ انا لست محظورآ \n') 
return false 
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖤍᭄ لا تسطيع كتم البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖤍᭄ عذرا لا تستطيع كتم ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖤍᭄ البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖤍᭄ عذرا لا تستطيع كتم ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 𖤍᭄ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☬︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fandam0')..')'
status  = '\n 𖤍᭄ تم كتم لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖤍᭄ عذرا لا تستطيع كتم ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖤍᭄ البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖤍᭄ لا تسطيع تقيد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖤍᭄ عذرا لا تستطيع تقيد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖤍᭄ عذرا لا تستطيع تقيد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fandam0')..')'
status  = '\n 𖤍᭄ تم تقيده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n 𖤍᭄ عذرا لا تستطيع تقيد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fandam0')..')'
status  = '\n 𖤍᭄  الايدي » `'..result.sender_user_id_..'`\n 𖤍᭄  تم رفعه مشرف '
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍᭄  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'fandam0')..')'
status  = '\n 𖤍᭄  الايدي » `'..result.sender_user_id_..'`\n 𖤍᭄  تم تنزيله ادمن من الكروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
local text = 
'\n 𖤍᭄ اعدادات الكروب كتالي √↓'..
'\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n 𖤍᭄  علامة ال {✓} تعني معطل'..
'\n 𖤍᭄  علامة ال {✘} تعني مفعل'..
'\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n 𖤍᭄  الروابط » { '..lock_links..
' }\n'..' 𖤍᭄  المعرفات » { '..lock_user..
' }\n'..' 𖤍᭄  التاك » { '..lock_hash..
' }\n'..' 𖤍᭄  البوتات » { '..lock_bots..
' }\n'..' 𖤍᭄  التوجيه » { '..lock_fwd..
' }\n'..' 𖤍᭄  التثبيت » { '..lock_pin..
' }\n'..' 𖤍᭄  الاشعارات » { '..lock_tagservr..
' }\n'..' 𖤍᭄  الماركدون » { '..lock_mark..
' }\n'..' 𖤍᭄  التعديل » { '..lock_edit..
' }\n'..' 𖤍᭄  تعديل الميديا » { '..lock_edit_med..
' }\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n'..' 𖤍᭄  الكلايش » { '..lock_spam..
' }\n'..' 𖤍᭄  الكيبورد » { '..lock_inlin..
' }\n'..' 𖤍᭄  الاغاني » { '..lock_vico..
' }\n'..' 𖤍᭄  المتحركه » { '..lock_gif..
' }\n'..' 𖤍᭄  الملفات » { '..lock_file..
' }\n'..' 𖤍᭄  الدردشه » { '..lock_text..
' }\n'..' 𖤍᭄   الفيديو » { '..lock_ved..
' }\n'..' 𖤍᭄   الصور » { '..lock_photo..
' }\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n'..' 𖤍᭄   الصوت » { '..lock_muse..
' }\n'..' 𖤍᭄  الملصقات » { '..lock_ste..
' }\n'..' 𖤍᭄  الجهات » { '..lock_phon..
' }\n'..' 𖤍᭄  الدخول » { '..lock_join..
' }\n'..' 𖤍᭄  الاضافه » { '..lock_add..
' }\n'..' 𖤍᭄  السيلفي » { '..lock_self..
' }\n'..' 𖤍᭄  الالعاب » { '..lock_geam..
' }\n'..' 𖤍᭄  التكرار » { '..flood..
' }\n'..' 𖤍᭄  الترحيب » { '..welcome..
' }\n'..' 𖤍᭄  عدد التكرار » { '..NUM_MSG_MAX..
' }\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n 𖤍᭄  علامة ال {✓} تعني مفعل'..
'\n 𖤍᭄  علامة ال {✘} تعني معطل'..
'\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n'..' 𖤍᭄  امر صيح » { '..kickme..
' }\n'..' 𖤍᭄  امر اطردني » { '..sehuser..
' }\n'..' 𖤍᭄  امر منو ضافني » { '..addme..
' }\n'..' 𖤍᭄  ردود المدير » { '..rdmder..
' }\n'..' 𖤍᭄  ردود المطور » { '..rdsudo..
' }\n'..' 𖤍᭄  الايدي » { '..idgp..
' }\n'..' 𖤍᭄  الايدي بالصوره » { '..idph..
' }\n'..' 𖤍᭄  الرفع » { '..setadd..
' }\n'..' 𖤍᭄  الحظر » { '..banm..' }\n\n┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉  ┉  ┉\n 𖤍᭄  CH » @XMGXM\n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_," 𖤍᭄ عذرآ تم قفل التثبيت")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖤍᭄ تم تثبيت الرساله")   
database:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_," 𖤍᭄ انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_," 𖤍᭄ لا توجد رساله مثبته")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖤍᭄ ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
end
end,nil) 
end
...
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_,msg.id_," 𖤍᭄ عذرآ تم قفل الثبيت")  
return false  
end
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖤍᭄ تم الغاء تثبيت الرساله")   
...
send(msg.chat_id_,msg.id_," 𖤍᭄ حسنآ ارسل اليه الرابط الان")
...
send(msg.chat_id_, msg.id_," 𖤍᭄ تم تفعيل الرابط") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖤍᭄ تم تعطيل الرابط") 
return false end
end
...
send(msg.chat_id_, msg.id_," 𖤍᭄ تم تفعيل الصوره") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖤍᭄ تم تعطيل الصوره") 
return false end
end
if text == "الرابط" then 
local status_Link = database:get(bot_id.."Link_Group:status"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_," 𖤍᭄ الرابط معطل") 
return false  
end
...
linkgp = ' 𖤍᭄ لا يوجد رابط ارسل ضع رابط'
end  
...
send(msg.chat_id_,msg.id_," 𖤍᭄ تم مسح الرابط")           
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ ارسل لي الصوره') 
return false
end
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم ازالة صورة الكروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ ارسل الان الوصف')
end
return false  
end
...
t  = ' 𖤍᭄ ارسل لي الترحيب الان'
tt = '\n 𖤍᭄ تستطيع اضافة مايلي !\n 𖤍᭄ دالة عرض الاسم »{`name`}\n 𖤍᭄ دالة عرض المعرف »{`user`}'
...
GetWelcome = ' 𖤍᭄ لم يتم تعيين ترحيب للكروب'
end 
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم تفعيل ترحيب الكروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم تعطيل ترحيب الكروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم ازالة ترحيب الكروب') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then       
send(msg.chat_id_, msg.id_," 𖤍᭄ ارسل الكلمه لمنعها")  
database:set(bot_id.."FaNdAm1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."FaNdAm1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," 𖤍᭄ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."FaNdAm1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."FaNdAm1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."FaNdAm1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."FaNdAm1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," 𖤍᭄ تم منع الكلمه مع التحذير")  
database:del(bot_id.."FaNdAm1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."FaNdAm1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."FaNdAm1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."FaNdAm1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," 𖤍᭄ ارسل الكلمه الان")  
database:set(bot_id.."FaNdAm1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."FaNdAm1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_," 𖤍᭄ تم الغاء منعها")  
database:del(bot_id.."FaNdAm1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."FaNdAm1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."FaNdAm1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
for k,v in pairs(list) do  
database:del(bot_id.."FaNdAm1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."FaNdAm1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."FaNdAm1:List:Filter"..msg.chat_id_,v)  
end  
send(msg.chat_id_, msg.id_," 𖤍᭄ تم مسح قائمه المنع")  
end
...
send(msg.chat_id_,msg.id_,' 𖤍᭄ تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'TEXT_SUDO',text)
database:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' 𖤍᭄ تم حفظ كليشة المطور')
return false
end
-----------------
...
send(msg.chat_id_, msg.id_, ' 𖤍᭄ تم ازالة كليشة الايدي')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 𖤍᭄ تم الغاء تعين الايدي") 
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم تعين الايدي')    
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " 𖤍᭄ لا توجد بوتات في الكروب")
else
local t = ' 𖤍᭄ عدد البوتات هنا >> {'..c..'}\n 𖤍᭄ عدد البوتات التي هي ادمن >> {'..x..'}\n 𖤍᭄ تم طرد >> {'..(c - x)..'} من البوتات'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == i then 
local a = '\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n 𖤍᭄ عدد البوتات التي هنا >> {'..n..'} بوت\n'
local f = ' 𖤍᭄ عدد البوتات التي هي ادمن >> {'..t..'}\n 𖤍᭄ ملاحضه علامة ال (✯) تعني ان البوت ادمن \n'
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, " 𖤍᭄ تم الغاء حفظ القوانين") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_," 𖤍᭄ تم حفظ قوانين الكروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_," 𖤍᭄ ارسل لي القوانين الان")  
end
end
if text == 'مسح القوانين' or text == 'حذف القوانين' then  
if Mod(msg) then
send(msg.chat_id_, msg.id_," 𖤍᭄ تم ازالة قوانين الكروب")  
...
send(msg.chat_id_, msg.id_," 𖤍᭄ لا توجد قوانين")   
end    
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤍᭄ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'fandam0')..') \n ☬︙ تـم قفـل التفليش ')  
end,nil)   
end
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم طرد المحذوفين')
end,nil)
end
end
...
if #list == 0 then
send(msg.chat_id_, msg.id_,' 𖤍᭄ لا توجد صلاحيات مضافه')
return false
end
t = "\n 𖤍᭄ قائمة الصلاحيات المضافه \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_, " 𖤍᭄ ارسل نوع الرتبه \n 𖤍᭄ {عـضـو -- ممـيـز -- ادمـن -- مـديـر}") 
end
...
send(msg.chat_id_, msg.id_, "* 𖤍᭄ تم مسح الصلاحيه *\n") 
end
if database:get(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,"* 𖤍᭄ تم الغاء الامر *\n") 
database:del(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == 'مدير' then
if not Constructor(msg) then
send(msg.chat_id_, msg.id_"* 𖤍᭄ تستطيع اضافه صلاحيات {ادمن - مميز - عضو} \n 𖤍᭄ ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'ادمن' then
if not Manager(msg) then 
send(msg.chat_id_, msg.id_,"* 𖤍᭄ تستطيع اضافه صلاحيات {مميز - عضو} \n 𖤍᭄ ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'مميز' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,"* 𖤍᭄  تستطيع اضافه صلاحيات {عضو} \n 𖤍᭄ ارسل الصلاحيه مجددا*\n") 
return false
end
end
...
send(msg.chat_id_, msg.id_, " 𖤍᭄ تـم اضـافـه الامـر") 
database:del(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖤍᭄ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'fandam0')..')'..'\n 𖤍᭄ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم مسح رسائلك'  )  
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ عدد رسائلك » { '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
...
if database:get(bot_id..'Free:Bots') then
database:del(bot_id..'Free:Bots') 
Text = '\n 𖤍᭄ تم تفعيل البوت الخدمي' 
else
Text = '\n 𖤍᭄ بالتاكيد تم تفعيل البوت الخدمي'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل البوت الخدمي' and SudoBot(msg) then  
...
if not database:get(bot_id..'Free:Bots') then
database:set(bot_id..'Free:Bots',true) 
Text = '\n 𖤍᭄ تم تعطيل البوت الخدمي' 
else
Text = '\n 𖤍᭄ بالتاكيد تم تعطيل البوت الخدمي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,' 𖤍᭄ تستطيع التنظيف ل1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,' 𖤍᭄ تم حذف {'..num..'}')  
end
...
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," 𖤍᭄ ارسل لي الاسم الان ")  
end
return false
end
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ الاذاعه معطله من قبل المطور الاساسي')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖤍᭄ ارسل الان اذاعتك \n 𖤍᭄ للخروج ارسل الغاء") 
return false
end 
...
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖤍᭄ ارسل لي التوجيه الان") 
return false
end 
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖤍᭄ ليست لدي صلاحية تغير اسم الكروب")  
else
sebd(msg.chat_id_,msg.id_,' 𖤍᭄ تم تغيير اسم الكروب الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_,'-𖤍᭄ لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n-𖤍᭄ اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
send(msg.chat_id_, msg.id_," 𖤍᭄ لا تستطيع تنزيل المطور الاساسي")
return false 
end
...
send(msg.chat_id_, msg.id_,"\n 𖤍᭄ تم تنزيل الشخص من الرتب التاليه \n 𖤍᭄ { "..dev..''..crr..''..cr..''..own..''..mod..''..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n 𖤍᭄  عذرا العضو لايملك رتبه \n")
end
...
send(msg.chat_id_, msg.id_," 𖤍᭄ تم مسح ردود المطور")
end

if text == ("ردود المطور") and SudoBot(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n 𖤍᭄ قائمة ردود المطور \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم حفظ الرد')
return false  
end  
end
if text and text:match("^(.*)$") then
if database:get(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,' ☬𖤍᭄ ارسل الرد الذي تريد اضافته')
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم ازالة الرد العام')
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ ارسل الكلمه تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ ارسل الكلمه تريد حذفها')
...
send(msg.chat_id_, msg.id_," 𖤍᭄ تم مسح ردود المدير")
end

if text == ("ردود المدير") and Manager(msg) then
local list = database:smembers(bot_id..'List:Manager'..msg.chat_id_..'')
text = " 𖤍᭄ قائمه ردود المدير \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم ازالة الرد ')
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ ارسل الكلمه التي تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ ارسل الكلمه التي تريد حذفها')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فانۨــہدامۘ⁶³').." غادر" or text == 'بوت غادر' then  
if Sudo(msg) and not database:get(bot_id..'Left:Bot'..msg.chat_id_)  then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم مغادرة الكروب') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'فانۨــہدامۘ⁶³')
send(msg.chat_id_, msg.id_,'ٱﺳ̭͠ ميِّ ٱلَڦميِّلَ 𓄹 𓄼 𓄽 ['..Namebot..'] ')
end
if text == 'الاحصائيات' then
if Sudo(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = ' الاحصائيات ✸ \n'..' 𖤍᭄ عدد الكروبات » {'..Groups..'}'..'\n 𖤍᭄  عدد المشتركين » {'..Users..'}'
send(msg.chat_id_, msg.id_,Text) 
end
return false
end
...
Text = ' 𖤍᭄ تم تفعيل مغادرة البوت'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = ' 𖤍᭄ بالتاكيد تم تفعيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and SudoBot(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = ' 𖤍᭄ تم تعطيل مغادرة البوت'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = ' 𖤍᭄ بالتاكيد تم تعطيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n 𖤍᭄ تم تعطيل ردود المدير' 
else
Text = '\n 𖤍᭄ بالتاكيد تم تعطيل ردود المدير'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤍᭄ تم تفعيل ردود المطور' 
else
Text = '\n 𖤍᭄ بالتاكيد تم تفعيل ردود المطور'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤍᭄ تم تعطيل ردود المطور' 
else
Text = '\n 𖤍᭄ بالتاكيد تم تعطيل ردود المطور'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤍᭄ تم تفعيل الايدي بالصور' 
else
Text = '\n 𖤍᭄ بالتاكيد تم تفعيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤍᭄ تم تعطيل الايدي بالصوره' 
else
Text = '\n 𖤍᭄ بالتاكيد تم تعطيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ ايديه ~⪼ '..iduser..'\n 𖤍᭄ معرفه ~⪼ '..username..'\n 𖤍᭄ رتبته ~⪼ '..rtp..'\n 𖤍᭄ تعديلاته ~⪼ '..edit..'\n 𖤍᭄ نقاطه ~⪼ '..NUMPGAME..'\n 𖤍᭄ جهاته ~⪼ '..Contact..'\n 𖤍᭄ رسائله ~⪼ '..Msguser..'')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ المعرف غير صحيح ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ رتبتك في البوت » '..rtp)
end
if text == "اسمي"  then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
if result.first_name_  then
first_name = ' 𖤍᭄ اسمك الاول » {`'..(result.first_name_)..'`}'
else
first_name = ''
end   
if result.last_name_ then 
last_name = ' 𖤍᭄ اسمك الثاني » {`'..result.last_name_..'`}' 
else
last_name = ''
end      
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,' 𖤍᭄ ايديك » '..msg.sender_user_id_)
end
if text == 'الرتبه' and tonumber(msg.reply_to_message_id_) > 0 then
function start_function(extra, result, success)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'fandam0')..')'
local iduser = result.sender_user_id_
...
local username = ('[@'..data.username_..']' or 'لا يوجد')
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,' 𖤍᭄ الايدي » ('..iduser..')\n 𖤍᭄ المعرف » ('..username..')\n 𖤍᭄ الرتبه » ('..rtp..')\n 𖤍᭄ نوع الكشف » بالرد')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_,msg.id_," 𖤍᭄ البوت ليس ادمن \n") 
return false  
end 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
local amer = ' ✸∫ عدد الادمنيه : '..data.administrator_count_..
'\n\n 𖤍᭄ عدد المطرودين : '..data.kicked_count_..
'\n\n 𖤍᭄ عدد الاعضاء : '..data.member_count_..
'\n\n 𖤍᭄ عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
'\n\n 𖤍᭄  اسم الكروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_, '\n 𖤍᭄ عذرا لا استطيع طرد ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )')
return false
end
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ عذرا لا استطيع طرد ادمنية الكروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم طردك من الكروب') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم تعطيل امر اطردني') 
end
end
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ المعرف غلط ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
send(msg.chat_id_, msg.id_,' 𖤍᭄ لا استطيع اصيح معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' 𖤍᭄ لا استطيع اصيح معرف بوتات') 
return false  
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,' 𖤍᭄ تعال حبي يصيحونك بل كروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم تعطيل امر صيح') 
end
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 𖤍᭄ الشخص الذي قام باضافتك هو » '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖤍᭄ انت دخلت عبر الرابط لتلح') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم تعطيل امر منو ضافني') 
end
end

if text == 'تفعيل ضافني' and Manager(msg) then   
if database:get(bot_id..'Added:Me'..msg.chat_id_) then
Text = ' 𖤍᭄ تم تفعيل امر منو ضافني'
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' 𖤍᭄ بالتاكيد تم تفعيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤍᭄ تم تعطيل امر منو ضافني'
else
Text = '\n 𖤍᭄ بالتاكيد تم تعطيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل صيح' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = ' 𖤍᭄ تم تفعيل امر صيح'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = ' 𖤍᭄ بالتاكيد تم تفعيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:del(bot_id..'Mod:User'..msg.chat_id_)
database:del(bot_id..'Special:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖤍᭄ تم تنزيل الكل من الرتب الاتيه \n 𖤍᭄ المميزين ، الادمنيه ، المدراء ، المنشئين \n')
end
...
Text = '\n 𖤍᭄ بالتاكيد تم تعطيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = ' 𖤍᭄ تم تفعيل امر اطردني'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' 𖤍᭄ بالتاكيد تم تفعيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤍᭄ تم تعطيل امر اطردني'
else
Text = '\n 𖤍᭄ بالتاكيد تم تعطيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖤍᭄ الصوره معطله") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 𖤍᭄ عدد صورك ~⪼ "..result.total_count_.." صوره‌‏", msg.id_, msg.id_, "md")
else
...
send(msg.chat_id_, msg.id_,'𖤍᭄ تم تغير الايدي ارسل ايدي لرؤيته')
end
...
local rtpg = rtpa
local amera = {
" 𖤍᭄ اروح فـدوه للـحلوين",
" 𖤍᭄ فديت الصاك محح",
" 𖤍᭄ فـدشـي عمـي",
" 𖤍᭄ دغـيرهـا شبـي هـاذ",
" 𖤍᭄ شهل الگيمر ",
" 𖤍᭄ شهل الصوره تخمبش ",
" 𖤍᭄ فديت الحلو ",
" 𖤍᭄ بـبكن حـلك ",
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, amer.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n 𖤍᭄ ايديك ~⪼ '..msg.sender_user_id_..'\n 𖤍᭄ معرفك ~⪼ '..username..'\n 𖤍᭄ رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 𖤍᭄ موقعك ~⪼ '..rtpa..'\n 𖤍᭄ تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n 𖤍᭄ رسائلك ~⪼ '..Msguser..'\n 𖤍᭄ نسبه تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n 𖤍᭄ السحكات ~⪼ '..edit..'\n 𖤍᭄ نقاطك ~⪼ '..NUMPGAME..'\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n 𖤍᭄ ايديك ~⪼ '..msg.sender_user_id_..'\n 𖤍᭄ معرفك ~⪼ '..username..'\n 𖤍᭄ رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 𖤍᭄ موقعك ~⪼ '..rtpa..'\n 𖤍᭄ تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n 𖤍᭄ رسائلك ~⪼ '..Msguser..'\n 𖤍᭄ نسبه  تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n 𖤍᭄ السحكات ~⪼ '..edit..'\n 𖤍᭄ نقاطك ~⪼ '..NUMPGAME..']\n')
else
send(msg.chat_id_, msg.id_, '\n 𖤍᭄ الصوره ~⪼ ليس لديك صور في حسابك'..'[\n 𖤍᭄ ايديك ~⪼ '..msg.sender_user_id_..'\n 𖤍᭄ معرفك ~⪼ '..username..'\n 𖤍᭄ رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 𖤍᭄ موقعك ~⪼ '..rtpa..'\n 𖤍᭄ تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n 𖤍᭄ رسائلك ~⪼ '..Msguser..'\n 𖤍᭄ نسبه تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n 𖤍᭄ السحكات ~⪼ '..edit..'\n 𖤍᭄ نقاطك ~⪼ '..NUMPGAME..']\n')
end 
end
end
else
...
if Num == 0 then 
Text = ' 𖤍᭄  ليس لديك سحكات'
else
Text = ' 𖤍᭄ عدد سحكاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "مسح سحكاتي" or text == "حذف سحكاتي" then  
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم مسح سحكاتك'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "حذف جهاتي" then  
send(msg.chat_id_, msg.id_,' 𖤍᭄ تم مسح جهاتك'  )  
...
if Num == 0 then 
Text = ' 𖤍᭄ لم تقم بأضافه احد'
else
Text = ' 𖤍᭄ عدد جهاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تنظيف المشتركين" and SudoBot(msg) then 
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,' 𖤍᭄  لا يوجد مشتركين وهميين في البوت \n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,' 𖤍᭄ عدد المشتركين الان » ( '..#pv..' )\n- تم ازالة » ( '..sendok..' ) من المشتركين\n- الان عدد المشتركين الحقيقي » ( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,' 𖤍᭄  لا يوجد كروبات وهميه في البوت\n')   
else
local FaNdAm = (w + q)
local sendok = #group - FaNdAm
if q == 0 then
...
send(msg.chat_id_, msg.id_,' 𖤍᭄ عدد الكروبات الان » { '..#group..' }'..FaNdAmk..''..FaNdAm..'\n*- الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
-- vardump(data) 
FaNdAmdx(msg.chat_id_, msg.id_, ' 𖤍᭄ ايدي المجموعة » ( '..msg.chat_id_..' )\n 𖤍᭄ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ✸∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ✸∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_," 𖤍᭄ تم اضافة له {"..numadded..'} من الرسائل')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' 𖤍᭄ ارسل لي عدد الرسائل الان') 
return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' 𖤍᭄ ارسل لي عدد النقاط التي تريد اضافتها') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_," 𖤍᭄ تم اضافة له {"..Num..'} من النقاط')  
end
...
if Num == 0 then 
Text = ' 𖤍᭄ لم تلعب اي لعبه للحصول على نقاط'
else
Text = ' 𖤍᭄ عدد نقاطك التي ربحتها هيه *» { '..Num..' } نقاط *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n* 𖤍᭄ لا استطيع البيع اقل من 1 *") 
return false 
end
if tonumber(database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,' 𖤍᭄ ليس لديك نقاط في الالعاب\n 𖤍᭄ اذا كنت تريد ربح نقاط \n 𖤍᭄ ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n 𖤍᭄ ليس لديك نقاط في هذه لعبه \n 𖤍᭄ لزيادة نقاطك في اللعبه \n 𖤍᭄ ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
send(msg.chat_id_,msg.id_,' 𖤍᭄ تم خصم *» { '..NUMPY..' }* من نقاطك \n 𖤍᭄ وتم اضافة* » { '..(NUMPY * 50)..' } رساله الى رسالك *')
end 
return false 
end
...
send(msg.chat_id_,msg.id_,'\n 𖤍᭄ اهلا عزيزي البوت هنا ادمن'..'\n 𖤍᭄ وصلاحياته هي ↓ \nٴ━━━━━━━━━━'..'\n 𖤍᭄ تغير معلومات الكروب ↞ ❴ '..info..' ❵'..'\n ☬︙ حذف الرسائل ↞ ❴ '..delete..' ❵'..'\n ☬︙ حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n ☬︙ دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n ☬︙ تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n ☬︙ اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,' 𖤍᭄ هاذا الامر خاص بالادمنيه\n 𖤍᭄ ارسل {م10} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
Text = [[
*𖤍᭄اهلا بك في قائمة الاوامر ↫ ⤈*
ٴ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
*𖤍᭄م1 ↫ اوامـر حماية المجموعة*
*𖤍᭄م2 ↫ اوامـر تعطيل ~ تفعيل*
*𖤍᭄م3 ↫ اوامـر ضع ~ اضف*
*𖤍᭄م4 ↫ اوامـر مسح ~ حذف*
*𖤍᭄م5 ↫ اوامـر الرفع والتنزيل*
*𖤍᭄م6↫ اوامـر التفعيل والتعطيل*
*𖤍᭄م7 ↫ اوامـر الكروب*
*𖤍᭄م8 ↫ اوامـر التحشيش*
*𖤍᭄م9 ↫ اوامـر مطور الاساسي *
*𖤍᭄م10 ↫ اوامـر الاعضاء*
ٴ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
 .[𖤍᭄𝗧𝗘𝗔𝗠 𝗗𝗘𝗩](t.me/XMGXM)➢  
]]
...
Text = [[
𖤍᭄اوامر حماية المجموعه ↫ ⤈
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄  قفل + فتح ↫ الامر… 
𖤍᭄  ↫ { بالتقيد ، بالطرد ، بالكتم }
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄  الروابط
𖤍᭄  المعرف
𖤍᭄  التاك
...
𖤍᭄ البوتات
𖤍᭄ صلاحيه
𖤍᭄  قائمه منع المتحركات
𖤍᭄  قائمه منع الصور
𖤍᭄  قائمه منع الملصقات
𖤍᭄  مسح قائمه المنع
𖤍᭄ المحذوفين
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄  حذف ↫ امر ...
...
𖤍᭄  الادمنيه
𖤍᭄  ادمن بالكروب
𖤍᭄  ادمن بكل الصلاحيات
𖤍᭄  القيود
𖤍᭄  تنزيل جميع الرتب
 ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄  اوامر التغير …
 ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄  تغير رد المطور + اسم
𖤍᭄  تغير رد منشئ الاساسي + اسم
𖤍᭄  تغير رد المنشئ + اسم
𖤍᭄  تغير رد المدير + اسم
𖤍᭄  تغير رد الادمن + اسم
𖤍᭄  تغير رد المميز + اسم
𖤍᭄  تغير رد العضو + اسم
𖤍᭄  تغير امر الاوامر
𖤍᭄  تغير امر م1 ↫ الئ م10
 ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
.[𖤍᭄𝗧𝗘𝗔𝗠 𝗗𝗘𝗩](t.me/XMGXM)➢
]]
send(msg.chat_id_, msg.id_,(help_text or Text)) 
...
𖤍᭄  الاوامر … كالتالي
 ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄ استعاده الاوامر
𖤍᭄ صيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين
𖤍᭄ كشف القيود
𖤍᭄ تعين الايدي
𖤍᭄  الحساب + ايدي الحساب
𖤍᭄ تنظيف + العدد
𖤍᭄ تنزيل الكل
𖤍᭄ منع + برد
𖤍᭄ ~ الصور + متحركه + ملصق ~
𖤍᭄ حظر ~ كتم ~ تقيد ~ طرد
𖤍᭄ المحظورين ~ المكتومين ~ المقيدين
𖤍᭄ الغاء كتم + حظر + تقيد ~ بالرد و معرف و ايدي
𖤍᭄ تقيد ~ كتم + الرقم + ساعه
𖤍᭄ تقيد ~ كتم + الرقم + يوم
𖤍᭄ تقيد ~ كتم + الرقم + دقيقه
𖤍᭄ تثبيت ~ الغاء تثبيت
𖤍᭄ الترحيب
𖤍᭄ كشف البوتات
𖤍᭄ الصلاحيات
𖤍᭄ كشف ~ برد ← بمعرف ← ايدي
𖤍᭄ تاك للكل
𖤍᭄ اعدادات المجموعه
𖤍᭄ عدد الكروب
𖤍᭄  ردود المدير
...
send(msg.chat_id_, msg.id_,'𖤍᭄  هاذا الامر خاص بمطور\n𖤍᭄  ارسل {م10} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
𖤍᭄ اوامر المطورين 
 ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄   تفعيل ↫ تعطيل 
𖤍᭄ المجموعات ↫ المشتركين ↫ الاحصائيات
𖤍᭄ رفع ↫ تنزيل منشئ اساسي
𖤍᭄ مسح الاساسين ↫ المنشئين الاساسين
𖤍᭄ مسح المنشئين ↫ المنشئين
𖤍᭄ اسم ↫ ايدي + بوت غادر 
𖤍᭄ اذاعه 
𖤍᭄ ردود المطور 
 ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
.[𖤍᭄𝗧𝗘𝗔𝗠 𝗗𝗘𝗩](t.me/XMGXM)➢
...
if text == 'م9' then
if not Sudo(msg) then
send(msg.chat_id_, msg.id_,'𖤍᭄  هاذا الامر خاص بالمطور الاساسي\n𖤍᭄  ارسل {م10} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
Text = [[
𖤍᭄ اهلا بك عزيزي √
𖤍᭄ اوامر مطور الاساسي...↓
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄ تفعيل
𖤍᭄ تعطيل
𖤍᭄ مسح الاساسين
𖤍᭄ المنشئين الاساسين
𖤍᭄ رفع/تنزيل منشئ اساسي
𖤍᭄ مسح المطورين
𖤍᭄ المطورين
𖤍᭄ رفع | تنزيل مطور
...
𖤍᭄ قائمه العام
𖤍᭄ مسح قائمه العام
𖤍᭄ جلب نسخه الاحتياطيه
𖤍᭄ رفع نسخه الاحتياطيه
 ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄ المتجر 
𖤍᭄ متجر الملفات
𖤍᭄ الملفات
𖤍᭄ مسح الملفات
𖤍᭄ تعطيل + تفعيل + اسم ملف
 ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄ اذاعه خاص
𖤍᭄ اذاعه
𖤍᭄ اذاعه بالتوجيه
𖤍᭄ اذاعه بالتوجيه خاص
𖤍᭄ اذاعه بالتثبيت
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄  جلب نسخه البوت
𖤍᭄ رفع نسخه البوت
𖤍᭄ ضع عدد الاعضاء + العدد
𖤍᭄ ضع كليشه المطور
𖤍᭄ تفعيل/تعطيل الاذاعه
𖤍᭄ تفعيل/تعطيل البوت الخدمي
𖤍᭄ تفعيل/تعطيل التواصل
𖤍᭄ تغير اسم البوت
𖤍᭄ اضف/حذف رد للكل
𖤍᭄ ردود المطور
𖤍᭄ مسح ردود المطور
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄ الاشتراك الاجباري
𖤍᭄ تعطيل الاشتراك الاجباري
𖤍᭄ تفعيل الاشتراك الاجباري
𖤍᭄ حذف رساله الاشتراك
𖤍᭄ تغير رساله الاشتراك
𖤍᭄ تغير الاشتراك
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄ الاحصائيات
𖤍᭄ المشتركين
𖤍᭄ المجموعات 
𖤍᭄ تفعيل/تعطيل المغادره
𖤍᭄ تنظيف المشتركين
𖤍᭄ تنظيف الكروبات
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
.[𖤍᭄𝗧𝗘𝗔𝗠 𝗗𝗘𝗩](t.me/XMGXM)➢
...
Text = [[
𖤍᭄ اهلا بك عزيزي √
𖤍᭄ اوامر الاعضاء كتالي…↓
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄ عرض معلوماتك ↑↓
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄ ايديي ← اسمي 
𖤍᭄ رسايلي ← مسح رسايلي 
𖤍᭄ رتبتي ← سحكاتي 
𖤍᭄ مسح سحكاتي ← المنشئ 
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄ اوآمر المجموعه ↑↓
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄ الرابط ← القوانين – الترحيب
𖤍᭄  ايدي ← اطردني 
𖤍᭄ اسمي ← المطور  
𖤍᭄ كشف ~ بالرد بالمعرف
𖤍᭄ كول + كلمه
  ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
𖤍᭄ اسم البوت + الامر ↑↓
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
...
𖤍᭄ مصه بالرد
𖤍᭄ رزله بالرد 
𖤍᭄ شنو رئيك بهذا بالرد
𖤍᭄ شنو رئيك بهاي بالرد
𖤍᭄ تحب هذا
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ٴ
].[𖤍᭄ اهلا بك عزيزي √
𖤍᭄ اوامر الاعضاء كتالي…↓
...
if text == "فديت" or text == "فديتج" or text == "فديتك" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ها  زاحف كمشتك","ازحف بعد ازحف🌚","شوكت تكبر وتبطل زحف ؟ 🌚"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
if text == "شغلي سبلت" or text == "شغل سبلت" or text == "شغليي سبلت" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"تم تشغيل سبلت بنجاح ❄️","شغلته 🌚🍃 بس حثلجون معليه ترا ","مابيه حيل اكوم 😒"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "حارة" or text == "حاره" or text == "حارةة" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"يي كولش 😭🍃🔥","اوف تموت حر 😭","جمر ليوم 😭😱"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "دوم" or text == "دووم" or text == "نشالله دوم" or text == "تدوم نشالله" or text == "دوم نشالله" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"يدوم نبضك ❤️🍃","يدوم عزك 🤍💫","تدوم ايامك 🤍💞"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "كافي" or text == "كافيي" or text == "ككافي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"اوك😐","كفكافةة بكلبك😹","ماشي😑"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "شنو" or text == "ششنو" or text == "شنو ؟" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"وششناوة 😹","معليكك😹","لظل تسأل 😒"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "بخير" or text == "الحمدلله" or text == "تمام" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"دوم❣","دوم يارب ❤","دوم وجيري 😹"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
FaNdAm = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(FaNdAm)
...
--------------------------------------------------------------------------------------------------------------
SourceFaNdAm(data.message_,data)
...
------------------------------------------------------------------------
local FaNdAmAbot = database:get(bot_id.."FaNdAm1:Add:Filter:Rp2"..text..result.chat_id_)   
if FaNdAmAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✸∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✸∫ ["..FaNdAmAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local FaNdAm1_Msg = database:get(bot_id.."FaNdAm1:Add:Filter:Rp2"..text..result.chat_id_)   
if FaNdAm1_Msg then    
send(msg.chat_id_, msg.id_," ✸∫ "..FaNdAm1_Msg)
